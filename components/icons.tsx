"use client";
// Inline stroke icons — Lucide grammar, 2px stroke, currentColor.
// Ported verbatim from public/proto/icons.jsx.
...
export const IconChevR = ({ size = 14, className = "", style = {} }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}><path d="M9 6l6 6-6 6"/></svg>;

export const IconChevD = ({ size = 14 }: IconProps) =>
...
export const IconChevL = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 6l-6 6 6 6"/></svg>;

export const IconCheck = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="5 12 10 17 19 7"/></svg>;

export const IconClose = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="6" y1="6" x2="18" y2="18"/><line x1="6" y1="18" x2="18" y2="6"/></svg>;

export const IconSearch = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="7"/><line x1="21" y1="21" x2="16.5" y2="16.5"/></svg>;

export const IconHome = ({ size = 16 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 11l9-7 9 7v9a2 2 0 0 1-2 2h-4v-7h-6v7H5a2 2 0 0 1-2-2z"/></svg>;

export const IconInbox = ({ size = 16 }: IconProps) =>
...
export const IconLayout = ({ size = 16 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg>;
...
export const IconBox = ({ size = 16 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>;

export const IconActivity = ({ size = 16 }: IconProps) =>
...
export const IconCog = ({ size = 16 }: IconProps) =>
...
export const IconCalendar = ({ size = 14 }: IconProps) =>
...
export const IconFlag = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 22V4M4 4h12l-2 4 2 4H4"/></svg>;

export const IconMessage = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>;

export const IconPaperclip = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"/></svg>;
...
export const IconPlay = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="0"><polygon points="6 4 20 12 6 20 6 4"/></svg>;
...
export const IconBolt2 = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>;

export const IconSparkles = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l1.5 4.5L18 8l-4.5 1.5L12 14l-1.5-4.5L6 8l4.5-1.5z"/><path d="M19 14l.75 2.25L22 17l-2.25.75L19 20l-.75-2.25L16 17l2.25-.75z"/><path d="M5 14l.5 1.5L7 16l-1.5.5L5 18l-.5-1.5L3 16l1.5-.5z"/></svg>;
...
export const IconUpload = ({ size = 14 }: IconProps) =>
...
export const IconFilter = ({ size = 14 }: IconProps) =>
...
export const IconUsers = ({ size = 14 }: IconProps) =>
...
export const IconGitFork = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="18" r="3"/><circle cx="6" cy="6" r="3"/><circle cx="18" cy="6" r="3"/><path d="M18 9v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V9"/><line x1="12" y1="12" x2="12" y2="15"/></svg>;
...
export const IconCircle = ({ size = 12 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="9"/></svg>;

export const IconDot = ({ size = 6 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 6 6" fill="currentColor"><circle cx="3" cy="3" r="3"/></svg>;

export const IconMore = ({ size = 14 }: IconProps) =>
...
export const IconKanban = ({ size = 16 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="6" height="14" rx="1"/><rect x="11" y="3" width="6" height="9" rx="1"/><rect x="19" y="3" width="2" height="6" rx="1"/></svg>;

export const IconList = ({ size = 16 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>;

export const IconBranch = ({ size = 14 }: IconProps) =>
...
export const IconJira = ({ size = 12 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor"><path d="M11.53 2C11.53 4.96 13.93 7.36 16.89 7.36H18.94V9.34C18.94 12.30 21.34 14.70 24.00 14.70V3.00C24.00 2.45 23.55 2 23.00 2H11.53zM5.78 7.78C5.78 10.74 8.18 13.14 11.14 13.14H13.19V15.12C13.19 18.08 15.59 20.48 18.55 20.48V8.78C18.55 8.23 18.10 7.78 17.55 7.78H5.78zM0 13.55C0 16.51 2.40 18.91 5.36 18.91H7.41V20.89C7.41 23.85 9.81 26.25 12.77 26.25V14.55C12.77 14.00 12.32 13.55 11.77 13.55H0z" transform="scale(0.8) translate(2,1)"/></svg>;

export const IconSmartsheet = ({ size = 12 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="3" y1="15" x2="21" y2="15"/><line x1="9" y1="3" x2="9" y2="21"/></svg>;

export const IconRobot = ({ size = 16 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="10" rx="2"/><circle cx="12" cy="5" r="2"/><line x1="12" y1="7" x2="12" y2="11"/><line x1="8" y1="16" x2="8" y2="16.01"/><line x1="16" y1="16" x2="16" y2="16.01"/></svg>;

export const IconBeaker = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 2v6l-5 9a3 3 0 0 0 2.6 4.5h10.8A3 3 0 0 0 20 17l-5-9V2"/><line x1="7" y1="2" x2="17" y2="2"/><line x1="6" y1="14" x2="18" y2="14"/></svg>;

export const IconHash = ({ size = 14 }: IconProps) =>
...
export const IconAt = ({ size = 14 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94"/></svg>;

export const IconMaximize = ({ size = 12 }: IconProps) =>
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 3 21 3 21 9"/><polyline points="9 21 3 21 3 15"/><line x1="21" y1="3" x2="14" y2="10"/><line x1="3" y1="21" x2="10" y2="14"/></svg>;
...
export const IconArrowSwitch = ({ size = 14 }: IconProps) =>
...
export const IconUser = ({ size = 14 }: IconProps) =>
